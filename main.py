...
if __name__ == "__main__":
    ...
    tags = repo.tags
    colunas = ['project', 'commit', 'commitprevious', 'class','release','BOC','TACH','FCH', 'LCH','CHO','FRCH','CHD','WCD' ,'WFR','ATAF','LCA','LCD','CSB','CSBS','ACDF']
    ...
    if(args.mode == 'tag'):
        for tag in tags:
            ...
            commit_A = tag
            release +=1            
        df.to_csv(args.projectName + ".csv", index=False)